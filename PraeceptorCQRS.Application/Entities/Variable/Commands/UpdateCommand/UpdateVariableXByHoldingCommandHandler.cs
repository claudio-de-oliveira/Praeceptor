...
{
    public class UpdateVariableXByHoldingCommandHandler
        : IRequestHandler<UpdateVariableXByHoldingCommand, ErrorOr<VariableResultX>>
    {
        private readonly IVariableXRepository _repository;

        public UpdateVariableXByHoldingCommandHandler(IVariableXRepository repository)
        {
            _repository = repository;
        }

        public async Task<ErrorOr<VariableResultX>> Handle(UpdateVariableXByHoldingCommand request, CancellationToken cancellationToken)
        {
