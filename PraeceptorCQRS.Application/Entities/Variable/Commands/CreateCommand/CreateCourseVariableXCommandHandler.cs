...
{
    public class CreateCourseVariableXCommandHandler
        : IRequestHandler<CreateCourseVariableXCommand, ErrorOr<VariableResultX>>
    {
        private readonly IVariableXRepository _repository;

        public CreateCourseVariableXCommandHandler(IVariableXRepository repository)
        {
            _repository = repository;
        }

        public async Task<ErrorOr<VariableResultX>> Handle(CreateCourseVariableXCommand request, CancellationToken cancellationToken)
        {
