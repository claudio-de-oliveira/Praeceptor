...
{
    public class CreateInstituteVariableXCommandHandler
        : IRequestHandler<CreateInstituteVariableXCommand, ErrorOr<VariableResultX>>
    {
        private readonly IVariableXRepository _repository;

        public CreateInstituteVariableXCommandHandler(IVariableXRepository repository)
        {
            _repository = repository;
        }

        public async Task<ErrorOr<VariableResultX>> Handle(CreateInstituteVariableXCommand request, CancellationToken cancellationToken)
        {
