...
{
    public class CreateVariableXByHoldingCommandHandler
        : IRequestHandler<CreateVariableXByHoldingCommand, ErrorOr<VariableResultX>>
    {
        private readonly IVariableXRepository _repository;

        public CreateVariableXByHoldingCommandHandler(IVariableXRepository repository)
        {
            _repository = repository;
        }

        public async Task<ErrorOr<VariableResultX>> Handle(CreateVariableXByHoldingCommand request, CancellationToken cancellationToken)
        {
