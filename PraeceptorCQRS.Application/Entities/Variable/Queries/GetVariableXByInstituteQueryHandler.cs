...
{
    public class GetVariableXByInstituteQueryHandler
        : IRequestHandler<GetVariableXByInstituteQuery, ErrorOr<VariableXListResult>>
    {
        private readonly IInstituteRepository _instituteRepository;
        private readonly IVariableXRepository _variableRepository;

        public GetVariableXByInstituteQueryHandler(IVariableXRepository variableRepository, IInstituteRepository instituteRepository)
        {
            _variableRepository = variableRepository;
            _instituteRepository = instituteRepository;
        }

        public async Task<ErrorOr<VariableXListResult>> Handle(GetVariableXByInstituteQuery request, CancellationToken cancellationToken)
        {
