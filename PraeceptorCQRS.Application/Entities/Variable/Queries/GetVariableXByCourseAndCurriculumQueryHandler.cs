...
{
    public class GetVariableXByCourseAndCurriculumQueryHandler
        : IRequestHandler<GetVariableXByCourseAndCurriculumQuery, ErrorOr<VariableXListResult>>
    {
        private readonly ICourseRepository _courseRepository;
        private readonly IVariableXRepository _variableRepository;

        public GetVariableXByCourseAndCurriculumQueryHandler(IVariableXRepository variableRepository, ICourseRepository courseRepository)
        {
            _variableRepository = variableRepository;
            _courseRepository = courseRepository;
        }

        public async Task<ErrorOr<VariableXListResult>> Handle(GetVariableXByCourseAndCurriculumQuery request, CancellationToken cancellationToken)
        {
