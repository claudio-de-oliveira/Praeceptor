...
{
    public class GetVariableXByHoldingQueryHandler
        : IRequestHandler<GetVariableXByHoldingQuery, ErrorOr<VariableXListResult>>
    {
        private readonly IHoldingRepository _holdingRepository;
        private readonly IVariableXRepository _variableRepository;

        public GetVariableXByHoldingQueryHandler(IVariableXRepository variableRepository, IHoldingRepository holdingRepository)
        {
            _variableRepository = variableRepository;
            _holdingRepository = holdingRepository;
        }

        public async Task<ErrorOr<VariableXListResult>> Handle(GetVariableXByHoldingQuery request, CancellationToken cancellationToken)
        {
