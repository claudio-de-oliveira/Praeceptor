...
public partial class WordDocument
{
    public static string NSID
        => Guid.NewGuid().ToString("D").Substring(0, 8).ToUpper();
    ...
    #endregion Add Parts to Package
    ...
    #endregion Properties from Parameters
    ...
    {
        Guard.Against.Null(TheMainDocumentPart.NumberingDefinitionsPart);
    ...
    protected static bool IsStyleIdInDocument(MainDocumentPart mainDocumentPart, string styleid)
    {
        ...
        var elements = s.Elements<Style>()
            .Where(st => (st.StyleId! == styleid) && (st.Type! == StyleValues.Paragraph));
        Guard.Against.Null(elements);

        Style? style = elements.FirstOrDefault();
        if (style == null)
            return false;
