...
{
    public class CreateSubSubSectionCommandValidator : AbstractValidator<CreateSubSubSectionCommand>
    {
        public CreateSubSubSectionCommandValidator(IInstituteRepository repository)
        {
            RuleFor(o => o.Title)
                .NotNull()
                .MaximumLength(1024);
