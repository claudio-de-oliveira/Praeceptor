namespace Document.App.DownloadFile.Interfaces
{
    /// <summary>
    ...
    public interface IDownloadFileService
    {
        ...
        ValueTask<bool> DownloadFileAsync(string fileName, string content);
        ...
        ValueTask<bool> DownloadFileAsync(string fileName, string content, string contentType);
    }
}