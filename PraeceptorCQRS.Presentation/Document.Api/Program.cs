...
using PraeceptorCQRS.Presentation.Document.Api;
...
builder.Services.AddAuthorization(options =>
{
    options.AddPolicy("ReadPolice", policy =>
          policy.RequireClaim("scope", "Document.API.Read", "Document.API.FullAccess"));
    options.AddPolicy("CreatePolice", policy =>
          policy.RequireClaim("scope", "Document.API.Create", "Document.API.FullAccess"));
    options.AddPolicy("UpdatePolice", policy =>
          policy.RequireClaim("scope", "Document.API.Update", "Document.API.FullAccess"));
