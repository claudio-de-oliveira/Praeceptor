...
namespace DocumentToWord.Api.Word
{
    public abstract partial class WordDocument
    {
        ...
        {
            var styles = TheMainDocumentPart?.StyleDefinitionsPart?.Styles;
                        ...
                        foreach (var e in style.ChildElements)
                            if (e is StyleParagraphProperties element)
                                foreach (var c in element.ChildElements)
                                    ...
                                    {
                                        Guard.Against.Null(child.NumberingId);
                                        Guard.Against.Null(child.NumberingId.Val);
        ...
        public string AddCommentPartToPackage()
        {
            ...
            if (TheMainDocumentPart?.WordprocessingCommentsPart != null)
            {
                Comments comments =
                    TheMainDocumentPart.WordprocessingCommentsPart.Comments;
            ...
            else
            {
                ...
                WordprocessingCommentsPart? commentPart =
                    TheMainDocumentPart?.AddNewPart<WordprocessingCommentsPart>();
                Guard.Against.Null(commentPart);
        ...
        public StyleDefinitionsPart AddStylesPartToPackage(Styles root = null!)
        {
            ...
            Guard.Against.Null(TheMainDocumentPart);
            part = TheMainDocumentPart.AddNewPart<StyleDefinitionsPart>();
            root ??= new Styles();
            root.Save(part);
            return part;
        }
        ...
        public string AddNumberingPartToPackage()
        {
            ...
            // Verify that the document contains a 
            // WordProcessingCommentsPart part; if not, add a new one.
            if (TheMainDocumentPart?.NumberingDefinitionsPart is not null)
            {
                Numbering numbering =
                    TheMainDocumentPart.NumberingDefinitionsPart.Numbering;
            ...
            else
            {
                ...
                NumberingDefinitionsPart? numberingPart =
                    TheMainDocumentPart?.AddNewPart<NumberingDefinitionsPart>();
                Guard.Against.Null(numberingPart);
        ...
        public Footnotes AddFootnotesPartToPackage(Footnotes _ = null!)
        {
            ...
            // Verify that the document contains a 
            // WordProcessingCommentsPart part; if not, add a new one.
            if (TheMainDocumentPart?.FootnotesPart != null)
            {
                footnotes =
                    TheMainDocumentPart.FootnotesPart.Footnotes;
            }
            else
            {
                // No WordprocessingCommentsPart part exists, so add one to the package.
                FootnotesPart? footnotesPart =
                    TheMainDocumentPart?.AddNewPart<FootnotesPart>();
                footnotes = new Footnotes();
                Guard.Against.Null(footnotesPart);
        ...
        public string AddGlossaryPartToPackage()
        {
            ...
            Guard.Against.Null(TheMainDocumentPart);
            if (TheMainDocumentPart.GlossaryDocumentPart is not null)
            {
                GlossaryDocument glossary =
                    TheMainDocumentPart.GlossaryDocumentPart.GlossaryDocument;
            ...
            else
            {
                GlossaryDocumentPart glossaryPart =
                    TheMainDocumentPart.AddNewPart<GlossaryDocumentPart>();
        ...
        public HeaderPart AddHeaderPartToPackage(List<Header> root = null!)
        {
            Guard.Against.Null(TheMainDocumentPart);
            HeaderPart part =
                TheMainDocumentPart.AddNewPart<HeaderPart>();
        ...
        public string AddStyleDefinitionsPartToPackage()
        {
            ...
            // WordProcessingCommentsPart part; if not, add a new one.
            Guard.Against.Null(TheMainDocumentPart);
            if (TheMainDocumentPart.StyleDefinitionsPart != null)
            {
                Styles? styles =
                    TheMainDocumentPart.StyleDefinitionsPart.Styles;

                Guard.Against.Null(styles);
                if (styles.HasChildren)
                {
                    id = styles.Descendants<Style>().Select(e => e.StyleId?.Value).Max() ?? null!;
                }
            }
            else
            {
                ...
                StyleDefinitionsPart styleDefinitionsPart =
                    TheMainDocumentPart.AddNewPart<StyleDefinitionsPart>();
        ...
        public ParagraphProperties ParagraphPropertiesFromParameters(Dictionary<string, object> list)
        {
            ...
            SpacingBetweenLines spacingBetweenLines = null!;
        ...
        protected static bool IsStyleIdInDocument(MainDocumentPart mainDocumentPart, string styleid)
        {
            ...
            Style? style = s.Elements<Style>()
                .Where(st => (st.StyleId == styleid) && (st.Type is not null && st.Type == StyleValues.Paragraph))
                .FirstOrDefault();
        ...
        protected static string GetStyleIdFromStyleName(MainDocumentPart mainDocumentPart, string styleName)
        {
            ...
            Guard.Against.Null(stylePart);
            Guard.Against.Null(stylePart.Styles);
            var filtered = stylePart.Styles.Descendants<StyleName>()
                .Where(s => {
                    Guard.Against.Null(s.Val?.Value);
                    if (!s.Val.Value.Equals(styleName))
                        return false;
                    var parent = s.Parent;
                    var tp = ((Style?)parent)?.Type;
                    Guard.Against.Null(tp);
                    return tp == StyleValues.Paragraph;
                });
            string? styleId = filtered.Select(n => ((Style?)n.Parent)?.StyleId).FirstOrDefault();
