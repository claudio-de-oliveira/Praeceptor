    ...
    public partial class CreateInitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreceptorRoleTypeTable", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreceptorRoleTypeTable_InstituteTable_InstituteId",
                        column: x => x.InstituteId,
                        principalTable: "InstituteTable",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeaTable", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PeaTable_ClassTable_ClassId",
                        column: x => x.ClassId,
                        principalTable: "ClassTable",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CourseSocialBodyTable",
                columns: table => new
                {
                    PreceptorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseSocialBodyTable", x => new { x.CourseId, x.PreceptorId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_CourseSocialBodyTable_CourseTable_CourseId",
                        column: x => x.CourseId,
                        principalTable: "CourseTable",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseSocialBodyTable_PreceptorRoleTypeTable_RoleId",
                        column: x => x.RoleId,
                        principalTable: "PreceptorRoleTypeTable",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseSocialBodyTable_PreceptorTable_PreceptorId",
                        column: x => x.PreceptorId,
                        principalTable: "PreceptorTable",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSocialBodyTable_PreceptorId",
                table: "CourseSocialBodyTable",
                column: "PreceptorId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseSocialBodyTable_RoleId",
                table: "CourseSocialBodyTable",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreceptorRoleTypeTable_InstituteId",
