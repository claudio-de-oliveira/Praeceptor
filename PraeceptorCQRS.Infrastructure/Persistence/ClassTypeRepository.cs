...
{
    public class ClassTypeRepository : AbstractRepository<ClassType>, IClassTypeRepository
    {
        public ClassTypeRepository(PraeceptorCQRSDbContext dbContext)
            : base(dbContext)
        { /* Nothing more todo */ }
        ...
        public async Task<PageOf<ClassType>> GetClassTypePage(
            Guid instituteId,
            int page,
            int pageSize,
            string? sort,
        ...
        private async Task<List<ClassType>> GetFilteredEntities(
            Guid instituteId,
            string? codeFilter,
            string? createdByFilter,
            string? createdFilter,
            ...
            )
        {
            ...
            var filteredList = new List<ClassType>();
